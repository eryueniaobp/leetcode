           ...
           // cout<<"level = " << level++ <<" size = " << ldeq.size()<<endl;
            while(!ldeq.empty()){
                ...
                if(cache.find(a) != cache.end()){
                    vector<string> ns = cache[a];
                    path[dn].push_back(ns[0]);
                    tmp.push_back(ns[0]);
                    if(ns[0].compare(end) == 0){
                        ans.push_back(path[dn]);
                    }
                        ...
                        if(b.compare(end) != 0 ){
                            ...
                            //  cout<<b<<" ";
                               ...
                               if(cache.find(a) != cache.end()){
                                ...
                                vector<string> node;node.push_back(b);
                                cache.insert(std::pair<string,vector<string> >(a,node));
                            }
                               tmp.push_back(b);
                               if(count++ == 0 ) {
                                  path[dn].push_back(b);
